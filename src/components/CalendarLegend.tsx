...
function LegendItem({ icon, title, description, borderClass = 'border' }: LegendItemProps) {
  return (
    <div className="flex gap-4 items-center">
      <div
        className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${borderClass}`}
      >
        {icon}
      </div>
      <div>
...
export function CalendarLegend() {
  return (
    <div className="p-8 pt-2 bg-gradient-to-b from-white to-rose-50/30">
      <h3 className="text-gray-800 font-bold mb-6 text-lg text-center">Comprendre votre cycle</h3>
