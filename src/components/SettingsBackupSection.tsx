    ...
    return (
        <div className="mb-6 pb-6 border-b border-gray-200">
            ...
            <p className="text-xs text-gray-500 mb-4">
                Comme vos données sont 100% locales, utilisez ces outils pour les transférer sur un autre appareil.
            </p>

            {importStatus && (
                <div className={`mb-4 p-3 rounded-xl text-sm font-medium animate-in slide-in-from-top-2 duration-300 ${importStatus.type === 'success'
            ...
            <div className="grid grid-cols-2 gap-3">
                ...
                >
                    {isPremium ? <Download className="w-4 h-4" /> : <Lock className="w-3.5 h-3.5 opacity-80" />}
                    Exporter (JSON)
                </button>
