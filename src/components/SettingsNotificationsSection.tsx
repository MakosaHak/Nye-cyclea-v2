...
export function SettingsNotificationsSection({ settings, onSettingChange }: SettingsNotificationsSectionProps) {
                ...
                <div className="mt-4 space-y-3">
                    ...
                    <div className="p-3 bg-blue-50/50 rounded-xl border border-blue-100/50">
                        <p className="text-[11px] text-blue-700 leading-relaxed">
                            ...
                            1. Vérifiez que l'application est bien <strong>ajoutée à votre écran d'accueil</strong>.<br />
