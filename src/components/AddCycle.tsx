...
export function AddCycle({ onClose }: AddCycleProps) {
  ...
  const formattedStartDate = startDate
    ? new Date(startDate).toLocaleDateString('fr-FR', { weekday: 'long', day: 'numeric', month: 'long' })
    : null;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await StorageService.addCycle(newCycle);
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'center', paddingTop: '14px', paddingBottom: '4px' }}>
            <div style={{ width: '40px', height: '4px', borderRadius: '99px', backgroundColor: 'rgba(244,63,94,0.2)' }} />
          </div>

          {/* Header */}
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', padding: '12px 24px 16px' }}>
            <div>
              <p style={{ fontSize: '11px', fontWeight: 800, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#f9a8ba', marginBottom: '2px' }}>
                Nouveau cycle
              </p>
          ...
          <form onSubmit={handleSubmit} style={{ padding: '0 24px 32px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div>
              ...
              <input
                ...
                style={{
                  ...
                  fontSize: '15px', fontWeight: 600, color: '#3b0a18',
              ...
              {formattedStartDate && (
                <p style={{ marginTop: '8px', marginLeft: '4px', fontSize: '12px', color: '#f43f5e', fontWeight: 600 }}>
                  📅 {formattedStartDate}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              <p style={{ fontSize: '12px', color: '#c084a0', marginLeft: '34px', marginBottom: '12px' }}>
              ...
              <div style={{
                ...
                <button
                  ...
                  style={{
                    ...
                    background: 'rgba(255,255,255,0.9)', border: '1.5px solid rgba(244,63,94,0.15)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    cursor: 'pointer', flexShrink: 0, boxShadow: '0 2px 8px rgba(244,63,94,0.08)',
                  }}
                >
                ...
                <div style={{ flex: 1, textAlign: 'center' }}>
                  <div style={{ fontSize: '52px', fontWeight: 800, color: '#f43f5e', lineHeight: 1 }}>
                    {periodDuration}
                  </div>
                  <div style={{ fontSize: '12px', fontWeight: 600, color: '#c084a0', marginTop: '2px', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              <button
                ...
                disabled={!startDate}
                style={{
                  flex: 2, height: '52px', borderRadius: '18px',
                  border: 'none',
